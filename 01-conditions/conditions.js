...
Conditions.prototype.maximum2Nombres = function (nombre1, nombre2) {

};

// Recherche et retourne le nombre le plus grand
Conditions.prototype.maximum3Nombres = function (nombre1, nombre2, nombre3) {

};

// Indique si le nombre est positif, négatif ou nul (== 0)
Conditions.prototype.signe = function (nombre) {

};

// Selon le nombre de côtés de même longueur,
// indique si un triangle est équilatéral, isocèle ou quelconque.
Conditions.prototype.typeTriangle = function (cote1, cote2, cote3) {

};

// Indique le nombre de valeurs identiques
Conditions.prototype.valeursIdentiques = function (nombre1, nombre2, nombre3) {

};

// Selon le numéro choisi, indique le jour de la semaine correspondant
// en toutes lettres.
Conditions.prototype.jourDeLaSemaine = function (numeroJour) {

};

// Selon le mois renseigné, indiquer le nombre de jours qu'il y a dans ce mois.
Conditions.prototype.nombreJours = function (mois) {

};

// Retourne vrai si le premier nombre est dans l'intervalle des deux suivants.
Conditions.prototype.intervalle = function (nombre1, nombre2, nombre3) {
...
Conditions.prototype.prixPhotocopies = function (nombre) {
